...
# Create a focused federal URL crawler that gets all child pages

federal_crawler = '''#!/usr/bin/env python3
"""
...
with open('federal_crawler.py', 'w') as f:
    f.write(federal_crawler)

print("✓ Created: federal_crawler.py")
print("  Focused crawler for federal URLs with child page discovery")
print()
